    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        ...
        <View style={styles.footer}>
          ...
          <TextInput style={styles.input} value={uf} maxLength={2} autoCapitalize="characters" autoCorrect={false}
            placeholder="Digite a UF" onChangeText={setUf}></TextInput>

          <TextInput style={styles.input} value={city} onChangeText={setCity} autoCorrect={false}
